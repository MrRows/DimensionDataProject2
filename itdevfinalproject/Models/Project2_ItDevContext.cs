...
{
    public partial class Project2_ItDevContext : DbContext
    {
        public Project2_ItDevContext()
        {
        }

        public Project2_ItDevContext(DbContextOptions<Project2_ItDevContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-JS9OEOU;Database=Project2_ItDev;Trusted_Connection=True;MultipleActiveResultSets=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.WorkExepienceId);

                entity.Property(e => e.WorkExepienceId).HasColumnName("WorkExepienceID");
            });
